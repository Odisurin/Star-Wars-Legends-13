...
//GLOBAL_LIST_INIT(jobs_regular_all, list(ADMIRAL, CLONE_COMMANDER, ENSIGN, CLONE_PILOT, CLONE_ENGINEER, MEDICAL_OFFICER, FIFTH_FLEET_CAPTAIN, REQ_OFFICER, SQUAD_SPECIALIST, CLONE_SERGEANT, CLONE_MEDIC, CLONE_MARKSMEN, CLONE_HEAVY, CLONE_TROOPER))